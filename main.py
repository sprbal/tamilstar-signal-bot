...
# Flask Web Server setup for Render (Free Web Service keep-alive)
app = Flask(__name__)
...
# ================= Configuration =================
BOT_TOKEN = "8980023345:AAHSiT-TuUZybq2bkUdW_TFPgfW4nJa35f4"
...
def signal_engine():
    ...
    while True:
        try:
            # Pick Random OTC Pair and Direction
            pair = random.choice(PAIRS)
            direction = random.choice(["CALL 🟢 (BUY)", "PUT 🔴 (SELL)"])
            
            # 1-Minute Calculation based on IST Time
            ...
            # Sleep interval for next signal (2 to 4 minutes)
...
# Start Signal Engine in Background Thread
