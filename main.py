...
def run_bot():
    print("தமிழ் ஸ்டார் விஐபி பாட் 24/7 இயங்குகிறது...")
    ...
    while True:
        try:
            ...
            # என்ட்ரி நேரம் தொடங்கும் வரை + கேண்டில் முடியும் வரை (2 நிமிடங்கள்)
            time.sleep(120)
            p1 = get_live_price()
            ...
            if direct_win:
                ...
                # MTG கேண்டிலுக்கான 1 நிமிட காத்திருப்பு
                time.sleep(60)
                p2 = get_live_price()
            ...
            # அடுத்த சிக்னலுக்கான இடைவெளி (90 வினாடிகள்)
            time.sleep(90)
